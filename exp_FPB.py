...
from torchreid.utils import (
    ...
    load_pretrained_weights, compute_model_complexity, collect_env_info, calc_model_params
)
from torchreid.models.nn_utils import OFPenalty
    ...
    if cfg.data.type == 'image':
        ...
        if cfg.loss.name == 'engine_FPB':
            ...
            engine = torchreid.engine.ImageFPBEngine(
                ...
                div_start = cfg.loss.div_reg_start
            )    
