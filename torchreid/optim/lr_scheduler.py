...
def build_lr_scheduler(optimizer, lr_scheduler='single_step', stepsize=1, gamma=0.1, max_epoch=1, warmup_multiplier=100, warmup_total_epoch=9):
    ...
    if lr_scheduler == 'single_step':
        ...
        scheduler = GradualWarmupScheduler(
            optimizer, multiplier=warmup_multiplier, total_epoch=warmup_total_epoch, after_scheduler=scheduler_multistep
        )
