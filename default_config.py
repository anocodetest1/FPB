...
def get_default_config():
    ...
    cfg.loss.div_reg = False
    cfg.loss.div_reg_beta = 1e-6
    cfg.loss.div_reg_start = 23
    ...
    cfg.test.multi_eval = False # when multiple datasets are used, whether to evaluate model on the combination of datasets rather than one by one
...
def engine_run_kwargs(cfg):
    return {
        ...
        'multi_eval': cfg.test.multi_eval,
